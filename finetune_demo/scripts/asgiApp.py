...
model_dir = Path("../models")  # Update with your GLM4 model path
model = None
tokenizer = None
...
def trim_history_by_tokens(history, max_tokens=2048):
...
async def get_response(query_model: QueryModel):
    ...
    user_history = trim_history_by_tokens(user_history)
